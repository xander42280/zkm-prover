...
impl Stage {
    ...
    fn gen_split_task(&mut self) {
        ...
        self.split_task.public_input_path.clone_from(&self.generate_context.private_input_path);
        self.split_task.private_input_path.clone_from(&self.generate_context.private_input_path);
